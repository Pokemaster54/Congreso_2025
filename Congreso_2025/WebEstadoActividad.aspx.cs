...
{
    public partial class WebEstadoActividad : System.Web.UI.Page
    {
        General general = new General();
        EstadoActividadDAO estadoDAO = new EstadoActividadDAO();
        ...
        {
            var lista = estadoDAO.ConsultarEstadosActividad();
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (estadoDAO.InsertarEstadoActividad(nombre))
            {
        ...
        protected void gvEstados_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            var entidad = new Estado_actividad { id_estado_actividad = id, nombre_estado_actividad = nombre };
            if (estadoDAO.ActualizarEstadoActividad(entidad))
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "ok",
        ...
        protected void gvEstados_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            if (estadoDAO.EliminarEstadoActividad(id))
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "ok",
