...
<asp:Content ID="ctHead" ContentPlaceHolderID="HeadContent" runat="server">
    <style>
        ...
        .lp-hero{
            position:relative; min-height:clamp(460px,70vh,780px);
            display:grid; place-items:center; border-radius:1.25rem; overflow:hidden;
        ...
        .line{
            ...
            stroke-dasharray:180 22; animation: dash 18s linear infinite;
        ...
        /* ===== Glass card ===== */
        .lp-card{
            position:relative; width:min(1040px,96%); z-index:1;
        ...
        .lp-badge{display:inline-flex;align-items:center;gap:.5rem;padding:.35rem .75rem;border-radius:999px;background:rgba(99,102,241,.12);color:#4f46e5;font-weight:600}
        .lp-title{font-weight:800;line-height:1.1;font-size:clamp(2rem,3.6vw,3.2rem);letter-spacing:-.02em;margin:.35rem 0 .5rem}
        ...
        .kpi{border-radius:16px;padding:18px;background:rgba(255,255,255,.82);border:1px solid rgba(0,0,0,.06)}
        ...
        /* CTA */
        .btn-aurora{
            position:relative; overflow:hidden; border-radius:14px; padding:.85rem 1.2rem;
            font-weight:600; border:0; background:linear-gradient(135deg,#4f46e5,#06b6d4); color:#fff;
        }
        .btn-aurora::before{
            content:""; position:absolute; inset:-40%;
            background: conic-gradient(from 0deg, transparent, rgba(255,255,255,.35), transparent 30%);
            animation:spin 3.5s linear infinite; filter:blur(12px);
        }
        ...
        <div class="lp-hero my-2 my-md-3">
            ...
            <div class="lp-lines" aria-hidden="true">
                <svg viewBox="0 0 1200 600" preserveAspectRatio="none">
                    ...
                    <!-- tres trazos curvos en distintas alturas -->
            ...
            <div class="lp-card">
                ...
                <p class="lp-sub mb-4">Todo lo que necesitas para gestionar ponentes y actividades .</p>

                <!-- KPIs desde BD -->
                <div class="lp-grid">
                    <div class="lp-kpi"><div class="kpi"><div class="label">Actividades próximas</div><div class="value"><asp:Label ID="lblKpiProximas" runat="server" Text="0" /></div></div></div>
                    <div class="lp-kpi"><div class="kpi"><div class="label">Ponentes</div><div class="value"><asp:Label ID="lblKpiPonentes" runat="server" Text="0" /></div></div></div>
                    <div class="lp-kpi"><div class="kpi"><div class="label">Ubicaciones</div><div class="value"><asp:Label ID="lblKpiUbicaciones" runat="server" Text="0" /></div></div></div>
                    <div class="lp-kpi"><div class="kpi"><div class="label">Tipos de actividad</div><div class="value"><asp:Label ID="lblKpiTipos" runat="server" Text="0" /></div></div></div>
                </div>
                ...
                <asp:Panel ID="pnlNext" runat="server" CssClass="next">
                    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2">
                        ...
                        <a runat="server" href="~/WebActividad.aspx" class="btn btn-aurora"><span><i class="fa-solid fa-calendar-check me-2"></i> Ver agenda</span></a>
                    </div>
                </asp:Panel>
            </div>
        </div>
