<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MenuCatedratico.Master"
    CodeBehind="WebLandingCatedratico.aspx.cs" Inherits="Congreso_2025.WebLandingCatedratico" %>

<asp:Content ID="ctHead" ContentPlaceHolderID="MainContent" runat="server">
    <style>
        ...
        .lp-lines svg { width: 100%; height: 100%; display: block; }
        .line {
        ...
        .lp-badge {
            ...
            background: rgba(99,102,241,.12); color: #4f46e5; font-weight: 600;
        }
        .lp-title {
            font-weight: 800; line-height: 1.1;
            font-size: clamp(2rem,3.6vw,3.2rem);
            letter-spacing: -.02em; margin: .35rem 0 .5rem;
        }
    ...
    <div class="container-fluid px-0 px-sm-2">
        <div class="lp-hero my-2 my-md-3">
            ...
            <div class="lp-card">
                <div class="mb-3">
                    <span class="lp-badge">Bienvenido al panel de Cátedra</span>
                </div>
                <h2 class="lp-title">Panel de Catedráticos — Congreso 2025</h2>
                <p class="lp-sub mb-4">
                    Consulta las actividades programadas, ponentes invitados y ubicaciones disponibles.  
                    Todos los catedráticos tienen acceso a la misma información global.
                </p>

                <!-- KPIs -->
                <div class="lp-grid">
                    <div class="lp-kpi"><div class="kpi"><div class="label">Actividades</div><div class="value"><asp:Label ID="lblKpiActividades" runat="server" Text="0" /></div></div></div>
                ...
                <asp:Panel ID="pnlNext" runat="server" CssClass="next">
                    <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2">
                        ...
                        <a runat="server" href="~/Actividades.aspx" class="btn btn-aurora"><span><i class="fa-solid fa-calendar-check me-2"></i> Ver agenda completa</span></a>
                    </div>
                </asp:Panel>
            </div>
        </div>
