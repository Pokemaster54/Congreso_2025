<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MenuAdmin.Master"
    CodeBehind="WebEstadoActividad.aspx.cs" Inherits="Congreso_2025.WebEstadoActividad" %>
...
<asp:Content ID="ctBreadcrumb" ContentPlaceHolderID="BreadcrumbContent" runat="server">
    Actividades &raquo; Estado de actividad
</asp:Content>
...
<asp:Content ID="ctMain" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid px-0 px-sm-2">
        <h2 class="mb-4">Gestión de Estados de actividad</h2>
            ...
            <div class="card-body">
                <div class="row g-3 row-cols-1 row-cols-md-2">
                    <div class="col">
                        ...
                        <asp:TextBox ID="txtNombreEstado" runat="server" CssClass="form-control" MaxLength="50" />
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <asp:GridView ID="gvEstados" runat="server"
                        ...
                        AutoGenerateColumns="False" DataKeyNames="id_estado_actividad" GridLines="None"
                        ...
                        <Columns>
                            <asp:BoundField DataField="id_estado_actividad" HeaderText="Código" ReadOnly="True" />

                            <asp:TemplateField HeaderText="Nombre">
                                <ItemTemplate>
                                    <asp:Label ID="lblNombre" runat="server" Text='<%# Eval("nombre_estado_actividad") %>' />
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtEditNombre" runat="server" CssClass="form-control"
                                                 Text='<%# Bind("nombre_estado_actividad") %>' MaxLength="50" />
                                </EditItemTemplate>
                            </asp:TemplateField>
